...
WSI_DIR_ROOT="/fslustre/qhs/ext_chen_yuheng_mayo_edu/RO1_GCP/Pipeline2/RO1_Amyloid"
DIR_LIST_FILE="/fslustre/qhs/ext_chen_yuheng_mayo_edu/script/out/amyloid_dir_list_pipeline2_all_focal_clean.txt"
...
if [ -d "$DIR_TO_PROCESS" ]; then
    ...
    python /fslustre/qhs/ext_chen_yuheng_mayo_edu/rhizonet/rhizonet/predict_gpu_focal_amyloid.py \
        --config_file /fslustre/qhs/ext_chen_yuheng_mayo_edu/rhizonet/data/setup_files/setup-predict_Amyloid_focal_amyloid_pipeline2.json \
