#!/bin/bash
#SBATCH --job-name=amyloid_pred_9117
#SBATCH --output=/fslustre/qhs/ext_chen_yuheng_mayo_edu/script/out/rhizonet_prediction_amyloid_9117_%A_%a.log
#SBATCH --error=/fslustre/qhs/ext_chen_yuheng_mayo_edu/script/out/rhizonet_prediction_amyloid_9117_%A_%a.err
...
# Target the specific case folder in Pipeline2
WSI_DIR_ROOT="/fslustre/qhs/ext_chen_yuheng_mayo_edu/RO1_GCP/Pipeline2/RO1_Amyloid/Cases/9117_22"
DIR_LIST_FILE="/fslustre/qhs/ext_chen_yuheng_mayo_edu/script/out/amyloid_dir_list_9117.txt"
...
if [ -d "$DIR_TO_PROCESS" ]; then
    ...
    nvidia-smi
    echo "-------------------"
    python /fslustre/qhs/ext_chen_yuheng_mayo_edu/rhizonet/rhizonet/predict_gpu.py \
        --config_file /fslustre/qhs/ext_chen_yuheng_mayo_edu/rhizonet/data/setup_files/setup-predict_Amyloid_priority_last.json \
