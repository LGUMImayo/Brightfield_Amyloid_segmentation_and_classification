#!/bin/bash
#SBATCH --job-name=amyloid_pred_all
#SBATCH --output=/fslustre/qhs/ext_chen_yuheng_mayo_edu/script/out/rhizonet_prediction_amyloid_all_%A_%a.log
#SBATCH --error=/fslustre/qhs/ext_chen_yuheng_mayo_edu/script/out/rhizonet_prediction_amyloid_all_%A_%a.err
...
DIR_LIST_FILE="/fslustre/qhs/ext_chen_yuheng_mayo_edu/script/out/amyloid_dir_list_pipeline_all.txt"
